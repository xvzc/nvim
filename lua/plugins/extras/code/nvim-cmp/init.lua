local function config()
  ...
  local util = require("plugins.extras.code.nvim-cmp.util")
  local mapping = require("plugins.extras.code.nvim-cmp.mapping")
  ...
  require("plugins.extras.code.nvim-cmp.style").apply_style()
end
