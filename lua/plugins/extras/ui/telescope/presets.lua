...
local function get_custom_entries()
  return {
    {
      name = "find_all_files",
    ...
    {
      name = "skeleton",
      func = telescope.extensions.skeleton.find_templates,
      -- opts = {
      --   path_display = { "tail" },
      -- },
    },
...
local M = {}
M.command_picker = function(opts)
  pickers
    .new(opts, {
      finder = finders.new_table({
        results = make_commands(get_custom_entries(), exclude),
